...
type Grade = { id: string; student_id: string; subject_id: string; class_id: string; assessment_name: string; score: number; max_score: number; note: string | null; grading_period_id: string | null }
...
export default function GradesPage() {
  ...
  async function loadGrades(id: string, sid: string, pid: string) {
    ...
    let query = supabase.from('grades').select('id,student_id,subject_id,class_id,assessment_name,score,max_score,note,grading_period_id').eq('class_id', id).eq('subject_id', sid).order('graded_at', { ascending: false })

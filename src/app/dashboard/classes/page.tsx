...
type SchoolClass = { id: string; name: string; grade_level_id: string | null; room: string | null; academic_year_id: string; grade_levels?: { short_name: string; name: string } | null; academic_years?: { name: string } | null }
...
export default function ClassesPage() {
  ...
  async function load() {
    ...
    setYears((y.data || []) as Year[]); setGrades((g.data || []) as GradeLevel[]); setClasses((c.data || []) as SchoolClass[])

...
type RelationGradeLevel = { short_name: string; name: string }
type RelationAcademicYear = { name: string }
type SchoolClass = { id: string; name: string; grade_level_id: string | null; room: string | null; academic_year_id: string; grade_levels?: RelationGradeLevel | null; academic_years?: RelationAcademicYear | null }
